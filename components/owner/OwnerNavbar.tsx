    ...
    >
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div
              className={`absolute right-0 mt-2 w-80 rounded-xl shadow-lg border overflow-hidden ${isDarkMode
            ...
            >
              ...
              <div className="max-h-64 overflow-y-auto">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    className={`px-4 py-3 border-b last:border-b-0 cursor-pointer transition-colors ${isDarkMode
