...
export function SearchBar() {
  ...
  const handleSearch = () => {
    ...
    router.push(
      `/customer/listing?checkIn=${formattedCheckIn}&checkOut=${formattedCheckOut}&adults=${adults}&children=${children}`
    );
  };
  ...
  return (
    <div className="w-full max-w-[1240x] bg-white rounded flex flex-col md:flex-row items-stretch relative">
      ...
      {/* Check-in / Check-out */}
      <div className="flex-1 px-4 md:px-6 py-3 md:py-0 md:border-r border-[#e5e5e5] flex flex-col justify-center">
        <label className="[font-family:'Poppins',Helvetica] font-semibold text-[#59A5B2] text-[10px] md:text-sm mb-1 flex items-center gap-2">
          <CalendarIcon className="w-4 h-4" />
          Check in - Check out
        </label>
        <Popover>
        ...
        <Popover open={isGuestsOpen} onOpenChange={setIsGuestsOpen}>
          ...
          <PopoverContent className="w-[280px] p-4" align="start">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="[font-family:'Poppins',Helvetica] font-semibold text-[#59A5B2] text-sm">Adults</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="w-8 text-center [font-family:'Poppins',Helvetica] font-semibold" data-testid="text-adults-count">
                    {adults}
                  </span>
                  <Button
                    size="icon"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="[font-family:'Poppins',Helvetica] font-semibold text-[#59A5B2] text-sm">Children</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="w-8 text-center [font-family:'Poppins',Helvetica] font-semibold" data-testid="text-children-count">
                    {children}
                  </span>
                  <Button
                    size="icon"
