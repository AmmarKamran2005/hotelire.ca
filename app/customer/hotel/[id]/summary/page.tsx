...
export default function BookingSummaryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("FINAL BOOKING PAYLOAD", { guestInfo, bookingData });
                ...
                <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 mb-4">
                  <div className="flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-16 h-10 bg-gray-300 rounded mx-auto mb-3 flex items-center justify-center">
                        <span className="text-gray-600 text-xs font-medium">Card</span>
                      </div>
                      <p
